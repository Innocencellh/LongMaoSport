 ...
 */
public class ZBRankActivity extends BaseActivity implements View.OnClickListener,ZBRankView{
    ...
    public void onZBRankSucc(ZBRankInfo result) {
        if (null != result && null != result.getBody()) {
          ...
          //  rankAdapter = new ZBRankAdapter(list, this);
            ...
            Toast.makeText(ZBRankActivity.this, "你还没有没有给主播礼物，快去送礼物给你的心仪主播", Toast.LENGTH_SHORT).show();
        }
    }

    @Override
    public void onZBRankError(String msg) {
        Toast.makeText(ZBRankActivity.this, "主播需要你的礼物", Toast.LENGTH_SHORT).show();
    }
}
