 ...
 * 直播列表页面
 */
public class SeeLiveFragment extends Fragment {
    private View v;
    private InsideViewPager mPager;// 页卡内容
    private RelativeLayout rl_title;
    private ImageView iv_search;

    public SeeLiveFragment() {
    ...
    private class SchemePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public SchemePagerAdapter(FragmentManager fm) {
            super(fm);
            frags[0] = new SeeHotFragment();
            frags[1] = new SeeEntertainmentFragment();
            frags[2] = new SeeSportFragment();
        }
