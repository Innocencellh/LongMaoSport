package com.live.longmao.imageshow;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager.getOverscrollView().setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int pos) {
                ...
                String filename = BaseApp.LONGMAOIMG + pos + ".jpg";
                final int degree = ImageUtil.readPictureDegree(filename);
                Glide.with(getContext()) // could be an issue!
                        ...
                        .into(new SimpleTarget<Bitmap>() {
                            ...
                            public void onResourceReady(Bitmap bitmap, GlideAnimation glideAnimation) {
                                ...
                                Bitmap map = ImageUtil.rotateBitmap(bitmap,degree);
