 ...
 */
public class ProfressionActivity extends BaseActivity implements ModificationMessageView {
    ...
    protected void setRigthClick(View v) {
        ...
        if (TextUtils.isEmpty(profression_et.getText().toString().trim())) {
            Toast.makeText(ProfressionActivity.this, "你还没有修改你的信息", Toast.LENGTH_SHORT).show();
        } else {
            modificationMessageHelper.getProfession(profression_et.getText().toString().trim());
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_back:
                startActivity(new Intent(ProfressionActivity.this, InfoActivity.class));
                finish();
                break;
        }
    }
    ...
    public void onModificationMessageSucc(ChangeEntayInfo result) {
        Toast.makeText(ProfressionActivity.this, "你的信息修改成功", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ProfressionActivity.this, InfoActivity.class));
        this.finish();
    }
