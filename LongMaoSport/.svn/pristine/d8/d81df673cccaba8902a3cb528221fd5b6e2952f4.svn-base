 ...
 */
public class UKPlayGuessingDlg1 extends DialogFragment implements View.OnClickListener {
    private Dialog dialog;
    private TextView textView, tv_user_guessing_tittle,
            tv_answerA, tv_answerB, tv_time, tv_ukdialog_num,btn_num_bean;
    ...
    private ImageView iv_a_bzb_all_jing_cai;
    ...
    private void initView() {
      ...
      //  btn_num_bean = (TextView) dialog.findViewById(R.id.btn_num_bean);
        ...
        iv_a_bzb_all_jing_cai.setOnClickListener(this);
    ...
    public UKPlayGuessingDlg1 setAllClick(OnClickAllListener onClickAllListener) {
