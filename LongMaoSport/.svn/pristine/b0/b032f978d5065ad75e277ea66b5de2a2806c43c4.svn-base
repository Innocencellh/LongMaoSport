...
import com.live.longmao.imageselector.adapter.FolderAdapter;
import com.live.longmao.imageselector.adapter.ImageGridAdapter;
import com.live.longmao.imageselector.bean.Folder;
import com.live.longmao.imageselector.bean.Image;
import com.live.longmao.imageselector.utils.FileUtils;
import com.live.longmao.imageselector.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public static final String TAG = "com.lilu.live.imageselector.MultiImageSelectorFragment";
                ...
                if (mImageAdapter.isShowCamera()) {
                    ...
                    if (i == 0) {
                        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA)
                            ...
                            requestPermissions(new String[]{Manifest.permission.CAMERA}, WRITE_EXTERNAL_STORAGE_REQUEST_CODE);
                        }else
                        {
