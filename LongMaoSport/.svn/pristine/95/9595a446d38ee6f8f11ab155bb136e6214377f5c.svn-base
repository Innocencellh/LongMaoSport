...
public class Constants {
    public static final String BD_EXIT_APP = "bd_lm_exit";
...
//    public static final int SDK_APPID = 1400001533;
    ...
    public static final int SDK_APPID = 1400011093;

    public static final int ACCOUNT_TYPE = 5574;
...
//    public static final int ACCOUNT_TYPE = 884;
    ...
    public static final String ROOT_DIR = "/sdcard/LongMao/";
    ...
    private static final String PACKAGE = "com.live.longmao";
