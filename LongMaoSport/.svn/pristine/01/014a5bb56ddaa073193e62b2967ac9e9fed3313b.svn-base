 ...
 */
public class ZBGuessBDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.a_zb_gurss_byes);
    ...
    private void initView() {
        ...
        tv_a_bean = (TextView) dialog.findViewById(R.id.zb_guess_a);
        tv_b_bean = (TextView) dialog.findViewById(R.id.zb_guess_b);
    ...
    public ZBGuessBDialog setAllClick(OnClickAllListener onClickAllListener) {
