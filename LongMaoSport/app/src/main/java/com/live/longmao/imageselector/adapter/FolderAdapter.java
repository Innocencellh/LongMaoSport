package com.live.longmao.imageselector.adapter;
...
public class FolderAdapter extends BaseAdapter {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    GlideUtil.getInstance().load(mContext, holder.cover, f.cover.path);
                }
            }else {
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
            if (data.cover != null) {
                GlideUtil.getInstance().load(mContext, cover, data.cover.path);
            }else{
