...
import com.live.longmao.views.customviews.CustomTextView;
...
//        }
        ...
        if (item.getType() != Constants.TEXT_TYPE) {
            ...
            spanString.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.light_gray_color)), 0, item.getSenderName().length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            ...
            spanString.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.title_color)),
...
//        holder.sendContext.fixViewWidth(mListView.getWidth());
    ...
    static class ViewHolder {
        public TextView tv_context,tv_level;
