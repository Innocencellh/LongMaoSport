...
public class OKhttpHelper {
    ...
    public static final String LOGIN = "http://121.40.65.153:8080/gwcommon/uic/login.do";
    public static final String REGISTER = "http://121.40.65.153:8080/gwcommon/uic/register.do";
