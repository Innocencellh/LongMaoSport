 ...
 */
public class ZBGuessingDlg1 extends DialogFragment implements View.OnClickListener {

    private Dialog dialog;
    private EditText tv_zb_guessing_tittle, et_zb_aAnswer, et_zb_bAnswer;
    private TextView tv_zb_time,tv_guess_xieyi;
    ...
    private TextView tv_zb_numbean,tv_zb_guess_bean;
...
private RelativeLayout rl_back;
    ...
    private void initView() {
        ...
        tv_zb_guess_bean = (TextView) dialog.findViewById(R.id.tv_zb_guess_bean);
        tv_guess_xieyi = (TextView) dialog.findViewById(R.id.tv_guess_xieyi);
        ...
        tv_guess_xieyi.setOnClickListener(this);
    ...
    public ZBGuessingDlg1 setAllClick(OnClickAllListener onClickAllListener) {
...
/* private boolean isEmptyView() {
            ...
            case R.id.rl_back:
                dismiss();
                break;
            case R.id.tv_guess_xieyi:
                mOnClickGiveListener.onClickHtml5();
                break;
