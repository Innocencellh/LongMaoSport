...
import com.live.longmao.activity.LiveClassificationActivity;
import com.live.longmao.util.DisplayUtil;
import com.live.longmao.views.SetActivity;
...
//        img = getResources().getDrawable(R.mipmap.home_icn_drop_down);
...
//                {
//                    if(isClickHot) {
//                        getContext().startActivity(new Intent(getContext(), LiveClassificationActivity.class));
//                        ((Activity)getContext()).overridePendingTransition(R.anim.activity_open,R.anim.activity_stay);
//                    }
//                    isClickHot=true;
//                }else
//                {
...
//                }
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 1) {
                isClickHot = true;
                // oneTab.setCompoundDrawables(null, null, null, img);
                oneTab.setCompoundDrawables(null, null, null, null);
//                oneTab.setCompoundDrawablePadding(DisplayUtil.dip2px(getContext(), -5));
