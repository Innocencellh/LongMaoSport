 ...
 */
public class ZBRankAdapter extends BaseAdapter {
    private ArrayList<ZBRankInfoBean> data = new ArrayList<>();
    private Context mContext;
    String url = "http://121.40.65.153/photo/";

    public ZBRankAdapter(ArrayList<ZBRankInfoBean> data, Context mContext) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)) {
            case 0:
                viewHolder1.tv_name.setText(data.get(0).getUserName());
                ...
                break;
            case 1:
                viewHolder2.tv_name.setText(data.get(1).getUserName());
