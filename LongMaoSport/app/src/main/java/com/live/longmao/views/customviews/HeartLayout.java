...
import com.live.longmao.util.AbstractPathAnimator;
import com.live.longmao.util.PathAnimator;
...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.icon_like_n);
