 ...
 */
public class ProfressionHobbiesActivity extends BaseActivity implements ModificationMessageView {
    ...
    protected void setRigthClick(View v) {
        ...
        if (TextUtils.isEmpty(profression_et.getText().toString().trim())) {
            Toast.makeText(ProfressionHobbiesActivity.this, "你还没有修改你的信息", Toast.LENGTH_SHORT).show();
        } else {
            modificationMessageHelper.getName(profression_et.getText().toString().trim());
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_back:
                startActivity(new Intent(ProfressionHobbiesActivity.this, InfoActivity.class));
                finish();
                break;
        }
    }
    ...
    public void onModificationMessageSucc(ChangeEntayInfo result) {
        Toast.makeText(ProfressionHobbiesActivity.this, "你的信息修改成功", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ProfressionHobbiesActivity.this, InfoActivity.class));
        this.finish();
    }
