 ...
 */
public class UKGuessYesDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.a_yh_gurss_yes);
    ...
    public UKGuessYesDialog setAllClick(OnClickAllListener onClickAllListener) {
