...
import com.live.longmao.fragment.ExchangeBeanFragment;
import com.live.longmao.fragment.ExchangeCoinFragment;
...
/**
 * Created by jz on 2016/9/29 0029.
 */
public class ExchangeRecordActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    private ExchangeBeanFragment beanFragment;
    private ExchangeCoinFragment coinFragment;
    /**
     * ViewPager的当前选中页
     */
    ...
    private void iniFragment() {
        coinFragment = new ExchangeCoinFragment();
        beanFragment = new ExchangeBeanFragment();
