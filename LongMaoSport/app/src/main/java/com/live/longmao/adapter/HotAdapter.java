...
import com.live.longmao.model.HotInfo;
...
//    }
    ...
    public HotAdapter(ArrayList<NewsInfo> datas, Context mContext) {
        this.datas = datas;
        this.mContext = mContext;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_living, viewGroup, false);
