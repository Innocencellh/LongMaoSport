 ...
 */
public class UKGuessNoDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.a_yh_guess_no);
    ...
    public UKGuessNoDialog setAllClick(OnClickAllListener onClickAllListener) {
