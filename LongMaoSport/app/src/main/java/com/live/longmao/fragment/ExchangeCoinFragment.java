...
public class ExchangeCoinFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (v == null) {
            v = inflater.inflate(R.layout.fragment_coin_exchange, container, false);
            initView();
            lazyLoad();
        }
    ...
    private void initView() {
        xListView = (XRecyclerView) v.findViewById(R.id.coin_xListView);
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("ExchangeCoinFragment");
    }
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("ExchangeCoinFragment");
    }
